...
- Found: 2026-06-20
- Description: Planning and executive function support app with visual timelines, task breakdowns, and accessibility-focused design for neurodivergent users.
...
### Autism Society of Minnesota: Executive Function Resources

- URL: https://ausm.org/ausm-resources/executive-function-resources/
- Source: perplexity-sonar
- Condition: executive-function
- Support category: sensory-regulation
- Query: executive function sensory regulation app
...
- URL: https://play.google.com/store/apps/details?id=com.theadhdexecutive.android&hl=en_US
- Source: perplexity-sonar
- Condition: executive-function
- Support category: sensory-regulation
- Query: executive function overload mobile app
- Found: 2026-06-21
- Description: Public Google Play listing for an app aimed at helping users think clearly and act deliberately when work, responsibility, and ADHD collide.

### Tiimo

- URL: https://cipworldwide.org/learning-hub/executive-functioning/12-apps-to-support-autistic-young-adults-with-executive-function-skills/
- Source: perplexity-sonar
- Condition: executive-function
- Support category: sensory-regulation
- Query: executive function overload mobile app
- Found: 2026-06-21
- Description: Listed as an executive function support app with visual timelines, AI task breakdown, and accessibility-focused planning features.

### Todoist

- URL: https://transitionsusa.org/blog/9-free-apps/
- Source: perplexity-sonar
- Condition: executive-function
- Support category: sensory-regulation
- Query: executive function overload mobile app
- Found: 2026-06-21
- Description: Recommended as a task-management app that supports organization, due dates, subtasks, and cross-device planning.

### Goblin Tools

- URL: https://wtcsb.org/adhd-apps-that-help-you-function-features-that-actually-matter/
- Source: perplexity-sonar
- Condition: executive-function
- Support category: sensory-regulation
- Query: executive function overload mobile app
