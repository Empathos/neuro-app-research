...
- Query: autism caregiver app
- Found: 2026-06-20
- Description: UT San Antonios AI-supported caregiver app for children with autism, designed to help parents practice behavioral skills and receive feedback outside clinic sessions.
...
- Query: autism caregiver app
- Found: 2026-06-20
- Description: An autism and IDD management and communication app for people with autism and their caregivers, with task management and secure communications for daily routines.

### Autism and Beyond

- URL: https://nyulangone.org/news/researchers-find-autism-screening-app-caregiver-friendly-produces-reliable-scientific-data
- Source: perplexity-sonar
- Condition: autism
- Support category: caregiver-clinician
- Query: autism caregiver app
- Found: 2026-06-20
- Description: A caregiver-friendly iPhone app from NYU Langone and collaborators that collected in-home screening data for autism-related behaviors.
...
- Query: autism clinician tool mobile app
- Found: 2026-06-21
- Description: A private, anonymous mobile screening tool for parents and clinicians informed by DSM-5 criteria. Provides quick results for autism spectrum disorder assessment and is available on the Apple App Store.

### Smart-ASD App - Clinician Tool for Student Needs

- URL: https://www.abtaba.com/blog/smart-autism-app
- Source: perplexity-sonar
- Condition: autism
- Support category: caregiver-clinician
- Query: autism clinician tool mobile app
