...
### Mobile Apps That Promote Emotion Regulation, Positive Mental Health, and Well-Being

- URL: https://pmc.ncbi.nlm.nih.gov/articles/PMC8663676/
- Source: perplexity-sonar
- Condition: sensory-processing
- Support category: emotional-regulation
- Query: sensory processing emotional regulation app
- Found: 2026-06-20
- Description: Peer-reviewed systematic review of mental health apps that promote emotion regulation and related well-being outcomes; useful for identifying evidence-backed app leads.

### Emotion Sense

- URL: https://www.cam.ac.uk/research/news/mood-tracking-app-paves-way-for-pocket-therapy
- Source: perplexity-sonar
- Condition: sensory-processing
- Support category: emotional-regulation
- Query: sensory processing mood tracking mobile app
- Found: 2026-06-21
- Description: Research-backed mood-tracking app that combines user mood reports with smartphone sensor data; launched for Android and described as open-source for sensor-data collection.
...
- Query: sensory processing mood tracking mobile app
- Found: 2026-06-21
- Description: Public mood-tracking app focused on charting daily highs and lows, sleep, medications, and related symptoms for bipolar and other mood disorders.

### How We Feel

- URL: https://apps.apple.com/us/app/how-we-feel/id1562706384
- Source: perplexity-sonar
- Condition: sensory-processing
- Support category: emotional-regulation
- Query: sensory processing mood tracking mobile app
- Found: 2026-06-21
- Description: Free science-based mood journal created with the Yale Center for Emotional Intelligence; supports daily emotional check-ins and well-being tracking.
